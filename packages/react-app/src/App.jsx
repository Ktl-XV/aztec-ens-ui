...
import "./App.css";
import { Account, Header, ThemeSwitch, NetworkDisplay, FaucetHint, NetworkSwitch } from "./components";
  ...
  */
  ...
  return (
    <div className="App">
      ...
      <Header title="Aztec ENS Transfer" link="/" subTitle="Send ETH to Aztec using ENS">
